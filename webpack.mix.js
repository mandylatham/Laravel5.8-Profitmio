...
mix.js('resources/js/pages/campaign/index.js', 'public/js/campaign-index.js')
    ...
    .sass('resources/sass/media-template/create.scss', 'public/css/media-template-details.css')
    .js('resources/js/pages/media-template/create.js', 'public/js/media-template-details.js')
