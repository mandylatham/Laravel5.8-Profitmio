                            ...
                            <form class="form" method="post" action="{{ secure_url('/template/create') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control" data-fv-field="type" required>
                                        <option value='email' {{ old('type') == 'email' ? 'selected' : '' }}>Email</optioni>
                                ...
                                <div id="email-fields">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="editor">{{ session('email_html') }} {{ old('email_html') }}</div>
                                        <input type="hidden" name="email_html" value="{{ session('email_html') ?: old('email_html') }}">
                                    </div>
                                </div>
                                <div id="sms-fields">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="send_vehicle_image">
                                                Send Vehicle Image
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="text_message_image" class="form-control" placeholder="Vehicle Image Location" value="{{ old('text_message_image') }}">
                                    </div>
                                </div>
                                <button id="add-template-button" class="btn btn-success">Add Template</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#add-template-button").click(function() {
                $("#add-template-button").attr('disabled', 'disabled').addClass('disabled');
