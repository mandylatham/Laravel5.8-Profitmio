    ...
    <div class="container" id="deployments-edit" v-cloak>
        <div class="edit-container">
            ...
            <form @submit.prevent="save" >
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <select id="type" name="type" class="form-control" required v-model="drop.type" :disabled="drop.status != 'Pending'">
                    ...
                    <div class="col-12 col-lg-3">
                        <div class="form-group">
                            ...
                            <date-picker v-model="drop.send_at_date" lang="en" type="date" format="MM/DD/YYYY" placeholder="" :disabled="drop.status != 'Pending'"></date-picker>
                        </div>
                    </div>
                    <div class="col-12 col-lg-3">
                        <div class="form-group">
                            <label for="type">Send Time</label>
                            <date-picker v-model="drop.send_at_time" lang="en" type="time" format="HH:mm" placeholder="" :disabled="drop.status != 'Pending'"></date-picker>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12" v-if="drop.type === 'email'">
                        <div class="form-group">
                            ...
                            <input id="email_subject" type="text" class="form-control" name="email_subject"
                                   ...
                                   autocomplete="off" :disabled="drop.status != 'Pending'">
                        </div>
                        <div class="form-group">
                            <label for="email_text">Email Text</label>
                            <textarea id="email_text" class="form-control" name="email_text" v-model="drop.email_text"
                                      placeholder="Email Plain Text" autocomplete="off" :disabled="drop.status != 'Pending'"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="email_html">Email HTML</label>
                            <editor v-model="drop.email_html" lang="html" height="800" @init="initEditor" :disabled="drop.status != 'Pending'"></editor>
                        </div>
                    </div>
                    <div class="col-12" v-if="drop.type === 'sms'">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="text_message" placeholder="Text Message"
                                      autocomplete="off" v-model="drop.text_message" :disabled="drop.status != 'Pending'"></textarea>
                        </div>
                ...
                <button type="submit" class="btn pm-btn pm-btn-purple mt-3" :disabled="loading" v-if="drop.status == 'Pending'">
