                            ...
                            <div class="card mb-3 card-feature text-to-value-container">
                                <div class="card-body">
                                    <div class="row no-gutters">
                                        <div class="col-12">
                                            <div class="feature-input">
                                                <p-check color="primary" :disabled="!campaign_has_mailer_phone || campaign.enable_text_to_value" class="p-default" name="enable_text_to_value" v-model="campaignForm.enable_text_to_value">Enable Text to Value</p-check>
                                            </div>
                                        </div>
                                    </div>
                                </div>
