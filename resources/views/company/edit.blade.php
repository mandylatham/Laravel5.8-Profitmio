                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('companies.update', ['company' => $company->id]) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name', $company->name) }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="type" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="type" required>
                                    <option value="support" {{ old('type', $company->type) == 'support' ? 'selected' : '' }}>Support</option>
                                    <option value="agency" {{ old('type', $company->type) == 'agency' ? 'selected' : '' }}>Agency</option>
                                    <option value="dealership" {{ old('type', $company->type) == 'dealership' ? 'selected' : '' }}>Dealership</option>
                                </select>
                                @if ($errors->has('type'))
                                    <span class="invalid-feedback" role="alert">
