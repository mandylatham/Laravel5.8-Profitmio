...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_url('/css/mosaico-material.min.css') }}" />
...
<div class="disclaimer" style="position: absolute; top: 10px; right: 10px; width: 140px; padding: .5em; background-color: #00b4f1; color: white; border: 2px dashed #d2cbb1">WARNING: experimental beta version, use with care!</div>
<!-- ko if: edits().length -->
...
<div class="subscribe" style="background-color: #00b4f1; color: white; padding: .5em">
